          ...
          <div className="overflow-x-auto scrollbar-hide snap-x snap-mandatory">
            <div className="flex gap-4 pb-2 min-w-min px-0">
              {products.map((product, idx) => (
                <div
                  key={product.id}
                  className="snap-center flex-shrink-0 w-[160px] animate-in fade-in slide-in-from-bottom-4 transition-all duration-500"
    ...
    <div className="bg-gradient-to-b from-slate-50 to-white min-h-screen">
      ...
      <section className="relative overflow-hidden py-20 sm:py-28 bg-gradient-to-br from-teal-500 via-teal-500 to-cyan-600">
        ...
        <div className="absolute inset-0 opacity-20 blur-3xl">
          <div className="absolute top-1/2 left-1/4 w-96 h-96 bg-white rounded-full mix-blend-multiply filter blur-3xl animate-blob" />
          <div className="absolute top-1/2 right-1/4 w-96 h-96 bg-cyan-300 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000" />
        </div>
