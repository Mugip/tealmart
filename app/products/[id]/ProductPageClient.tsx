...
import { 
  ...
  ChevronRight, X, Heart, Share2, RotateCcw, PlayCircle 
} from 'lucide-react'
              ...
              >
                ...
                {allImages.length > 1 && (
                  <>
                    ...
                    <button onClick={nextImage} className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white p-3 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity">
