...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed inset-y-0 right-0 w-full max-w-md bg-white z-[110] flex flex-col shadow-2xl animate-in slide-in-from-right duration-500">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-5">
          ...
          {items.length === 0 ? (
             <div className="py-20 flex flex-col items-center justify-center text-center space-y-4">
               ...
               <button 
                 onClick={() => { setIsDrawerOpen(false); router.push('/products') }}
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between py-0.5">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden h-8 bg-gray-50">
                      <button onClick={() => updateQuantity(item.id, item.quantity - 1)} className="px-2 hover:bg-white text-gray-500">
          ...
          {/* Upsells */}
          {upsells.length > 0 && (
            <div className="mt-4 border-t border-dashed border-gray-200 pt-6 pb-10 bg-gray-50/50 rounded-xl">
              <div className="px-5 mb-4 flex items-center justify-between">
                <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2">
                  <Sparkles size={16} className="text-yellow-500 fill-yellow-500" /> Pairs well with...
                </h3>
              </div>
        ...
        {items.length > 0 && (
          <div className="p-6 border-t bg-white shadow-[0_-10px_20px_rgba(0,0,0,0.05)]">
            ...
            <div className="space-y-3">
              ...
              >
                {loadingCheckout ? 'Loading...' : 'Checkout Now'} <ArrowRight size={20} />
              </button>
